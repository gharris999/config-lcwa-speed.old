...
######################################################################################################
SCRIPT_VERSION=20201222.124430
...
if [[ -z "$INCSCRIPTVER" ]] || [[ $INCSCRIPT_VERSION -lt $REQINCSCRIPTVER ]]; then
...
env_vars_defaults_get(){
	...
	[ -z "$LCWA_VERSION" ] 			&& LCWA_VERSION=20201222.124430
